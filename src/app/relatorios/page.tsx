            ...
            <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
              ...
              <div className="px-4 lg:px-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-blue-600">{formatCurrency(financialSummary.netBalance)}</div>
                    <p className="text-xs text-muted-foreground mt-1">
                      +28.7% vs período anterior
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold text-purple-600">{formatPercentage(financialSummary.savingsRate)}</div>
                    <p className="text-xs text-muted-foreground mt-1">
